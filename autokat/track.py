...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-u", "--huemin", default=20, type=int, help="Hue Minimum Threshold"
    )
    parser.add_argument(
        "-U", "--huemax", default=160, type=int, help="Hue Maximum Threshold"
    )
    parser.add_argument(
        "-s", "--satmin", default=100, type=int, help="Saturation Minimum Threshold"
    )
    parser.add_argument(
        "-S", "--satmax", default=255, type=int, help="Saturation Maximum Threshold"
    )
    parser.add_argument(
        "-v", "--valmin", default=200, type=int, help="Value Minimum Threshold"
    )
    parser.add_argument(
        "-V", "--valmax", default=255, type=int, help="Value Maximum Threshold"
    )
    parser.add_argument(
        "-d", "--display", action="store_true", help="Display Threshold Windows"
    )
